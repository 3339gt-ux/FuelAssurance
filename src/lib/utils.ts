...
/**
 * Generate a collision-resistant ID safe in browser and server contexts.
 * Works over HTTP LAN URLs where crypto.randomUUID() is unavailable.
 */
export function generateId(): string {
  ...
  if (cryptoApi && typeof cryptoApi.randomUUID === 'function') {
    try {
      ...
      // Fall through when randomUUID is blocked outside a secure context.
    }
  }
